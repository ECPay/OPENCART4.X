...
$_['entry_MinAmount']                   = '訂單最低金額';
$_['entry_MaxAmount']                   = '訂單最高金額';
...
$_['error_MaxAmount']                   = '請輸入' . $_['entry_MaxAmount'] .'(須大於' . $_['entry_MinAmount'] . ')';
$_['error_sender_address']              = '請輸入' . $_['entry_sender_address'];
$_['error_sender_zipcode']              = '請輸入' . $_['entry_sender_zipcode'];
